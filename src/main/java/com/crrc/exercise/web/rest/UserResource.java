...
import com.crrc.exercise.service.MailService;
import com.crrc.exercise.service.UserService;
import com.crrc.exercise.service.dto.UserDTO;
import com.crrc.exercise.web.rest.errors.BadRequestAlertException;
import com.crrc.exercise.web.rest.errors.EmailAlreadyUsedException;
import com.crrc.exercise.web.rest.errors.LoginAlreadyUsedException;
...
public class UserResource {
    ...
    @Timed
    @PreAuthorize("hasRole(\"" + AuthoritiesConstants.ADMIN + "\")")
    public ResponseEntity<Void> deleteUser(@PathVariable String login) throws URISyntaxException{
